<template>
    <div class="demo-container">
        <div class="demo">
                ...
                <p class="subtitle">使用 Codemirror 6 和 Vue3，基于 Remark & Rehype 生态构建的最新一代 Markdown 编译器。<br><i>version 0.0.8</i></p>
...
import { CasketStar, ToolLink, ToolTable, getEmptyPlugins, getDefaultToolbarL, getDefaultToolbarR, markdown } from 'casket-star';
...
const plugins = computed(() => {
    const plugins = getEmptyPlugins();

    plugins.codemirror = plugins.codemirror || [];
    plugins.remark = plugins.remark || [];
    plugins.rehype = plugins.rehype || [];

    plugins.remarkRehypeOptions = plugins.remarkRehypeOptions || {};
